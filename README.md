...
If you depend on the exact behavior of v1:
...
| --- | --- | --- |
| **chason-design** | `chason-design` | The default skill. Reads the brief, infers the design language, tunes three dials (VARIANCE / MOTION / DENSITY). Brief inference, design-system map, hard em-dash ban, canonical GSAP code skeletons, redesign-audit protocol, strict pre-flight check. |
| **chason-design-v1** | `chason-design-v1` | The original v1, preserved for projects depending on its exact behavior. Use only if the default breaks something specific in your workflow. |
...
- Start with **chason-design** for the safest general default.
- If you depend on the exact behavior of the original, install **chason-design-v1** instead.
